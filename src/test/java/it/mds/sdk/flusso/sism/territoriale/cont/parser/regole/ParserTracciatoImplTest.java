...
class ParserTracciatoImplTest {
    ...
    private static final String FILE_TRACCIATO_SISMTER = "tracciato-ter-cont-test.csv";
    ...
    void validaTracciatoOK() {
        ...
        File tracciato = new File(absolutePath + FileSystems.getDefault().getSeparator() + FILE_TRACCIATO_SISMTER);
